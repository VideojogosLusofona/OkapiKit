...
namespace OkapiKit
{
    [AddComponentMenu("Okapi/Action/Quest Give")]
    public class ActionQuestGive : Action
    {
        [SerializeField]
        ...
        public override string GetActionTitle() { return "Give Quest"; }
        ...
        public override string GetRawDescription(string ident, GameObject gameObject)
        {
            ...
            desc += $"Give quest \"{questName}\" {targetName}";
        ...
        protected override void CheckErrors()
        {
            ...
            if (quest == null)
            {
                _logs.Add(new LogEntry(LogEntry.Type.Warning, "Undefined target quest!", "You need to define the quest to give!"));
            }
