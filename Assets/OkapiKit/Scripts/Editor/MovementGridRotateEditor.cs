...
{
    [CustomEditor(typeof(MovementGridRotate))]
    public class MovementGridRotateEditor : MovementEditor
    {
        SerializedProperty propSpeed;
        SerializedProperty propCooldown;
        SerializedProperty propAngularStepSize;
        ...
        protected override void OnEnable()
        {
            ...
            propAngularStepSize = serializedObject.FindProperty("angularStepSize");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (WriteTitle())
            {
                ...
                EditorGUILayout.PropertyField(propAngularStepSize, new GUIContent("Angular Step", "How much to rotate on each step"));
